...
namespace JobBoard.Controllers
{
    public class RecruitersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReId,RecruiterName,RecruiterAddress,Email")] Recruiter recruiter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReId,RecruiterName,RecruiterAddress,Email")] Recruiter recruiter)
        {
            if (ModelState.IsValid)
            {
